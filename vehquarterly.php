<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		if(isset($_POST['quarterly'])){
			...
			$veh_id = $_POST['veh_id'];
			if ($qtr_main->add_vehilce_qtrly_data($veh_id, $data)){
				header('location: qtlyalterts.php?compat=8');
			}
		}else{
...
<head>
  <meta charset="utf-8">
	<title>Process Quarterly Checklist</title>
    <meta charset="utf-8">
						  ...
						  <div class="panel-heading">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" >
										<h4 class=" text-primary">Process  Quarterly Checklist</h4>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" >
						  ...
						  <input type="hidden" name="veh_id" value="<?php echo $veh_id; ?>" />
							...
							<tr>
								...
								<td>
									...
									<input type="checkbox" onclick="selectCheckbox(this)" value="<?php echo $veh['quarterly_checklist_ID']; ?>" name="quarterly[<?php echo $veh['quarterly_checklist_ID']; ?>]" value="" > Completed
								</td>
								<td><input type="text" disabled class="form-control" name="quarterly[<?php echo $veh['quarterly_checklist_ID']; ?>]['remark'" placeholder="comments" /></td>
							</tr>
							<?php $c++; } ?>
							<tr>
