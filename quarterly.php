...
<head>
  <meta charset="utf-8">
	<title>Quarterly Checklist</title>
    <meta charset="utf-8">
						...
						<div class="panel panel-default">
						  ...
						  <div class="panel-heading">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" >
										<h4 class=" text-primary">Quarterly Checklist</h4>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" >
										<a  href="add_quarterly.php"><button style="float:right"class="btn btn-primary"><i class="fa fa-plus-circle" ></i> Add Quarterly Maintenance</button></a>
									</div>
								</div>
							</div>
						  <div class="panel-body">
							...
							<tr>
								...
								<td>
									<a onclick="return confirm_alert(this);" href="quarterly.php?del=<?php echo $veh['quarterly_checklist_ID']; ?>" title="Delete Item" ><i class="fa fa-close" style="color:red;"></i></a>
								</td>
							</tr>
							<?php $c++; } ?>
