<?php
	...
	$vehicle = new Vehicle(); 
	$pending = $vehicle->get_vehicle_detailalerts_yrly();
	...
	if(Isset($_POST['submit'])) {
		...
		if (($_POST['from'] != '') && ($_POST['to'] !='') && ($_POST['company'] =='') ){
			...
			$pending = $vehicle->yearly_dateonly_alerts($_POST['from'],$_POST['to']);
		} 
		else if (($_POST['from'] != '')  && ($_POST['to'] != '')  && ($_POST['company']) != '' ) {
			$pending = $vehicle->yearly_dateandcompany_alert($_POST['from'],$_POST['to'],$_POST['company']);
		} 
		else if (($_POST['from'] == '' )  && ($_POST['to'] == '')  && ($_POST['company']) != '') {
			$pending = $vehicle->yearly_company_alert($_POST['company']);
		}
		else{
			$pending = $vehicle->get_vehicle_detailalerts_yrly();
		}
	...
	<?php require_once('nav_inc.php'); ?> 
			...
			<?php if($msg_rec){ ?>
				...
				<div class="row">
					...
					<a href="yralterts.php"><div class="col-lg-4 col-md-4 text-center tab active">
						Yr Maint
					</div></a>
				</div>
				<br /><br />
						  ...
						  <div class="panel-heading">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" >
										<h4 style="color:#449D44;">Yrly Checklist</h4>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" >
