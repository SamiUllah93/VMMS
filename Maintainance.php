						...
						<div class="panel panel-default">
						  ...
						  <div class="panel-heading">
								<div class="row">
									...
									<h4 class=" text-primary">Maint</h4>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" >
										<a  href="add_maintenance.php"><button style="float:right"class="btn btn-primary"><i class="fa fa-plus-circle" ></i> Add New Maint Type</button></a>
									</div>
								</div>
							</div>
