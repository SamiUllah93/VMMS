...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2021 at 10:25 PM
...
(5, 'Laeeq Rehman', 'PA-45645', '2021-11-06 21:36:28.490528', 0),
(6, 'Anees Ahmad Khan', 'PA-5467', '2021-11-06 21:36:38.005154', 0),
(7, 'Ghafoor', 'PAL-998', '2021-11-21 21:05:32.521151', 0);
...
CREATE TABLE `maintenance_vehicle` (
  ...
  `next_distance` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `maintenance_vehicle`
  MODIFY `maintenance_vehicle_ID` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `process_maintenance`
  MODIFY `process_maintenance_id` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `quarterly_maintenance_vehicle`
  MODIFY `quarterly_maintenance_vehicle_ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `vehicle`
  MODIFY `Vehicle_ID` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `yearly_checklist_maintenance`
  MODIFY `yearly_checklist_maintenance_ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
