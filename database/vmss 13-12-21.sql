...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2021 at 08:08 PM
...
(15, 30, '50', '1000', '2021-12-12 18:11:17', 0);
...
(27, 1, 30, 30, 1000, 0, '2022-01-11'),
(28, 2, 30, 20, 500, 0, '2022-01-01');
...
(50, 1, 30, 'ok', 0, '2021-12-12 23:04:12'),
(51, 3, 30, 'ok', 0, '2021-12-12 23:04:12'),
(52, 5, 30, 'ok', 0, '2021-12-12 23:04:12'),
(53, 1, 30, 'ok', 0, '2021-12-12 23:05:54'),
(54, 3, 30, 'ok', 0, '2021-12-12 23:05:54'),
(55, 5, 30, 'ok', 0, '2021-12-12 23:05:54'),
(56, 1, 30, 'ok', 0, '2021-12-12 23:10:35'),
(57, 3, 30, 'ok', 0, '2021-12-12 23:10:35');
...
(30, 'RLA2223', '5ton', '2021-12-01', 2010, 2000, '2022-03-12', '2022-12-12', 5, 2, '2021-12-12 17:44:56.185484', 0);
...
(21, 1, 30, 0, 0, '2021-12-12 23:10:46'),
(22, 2, 30, 0, 0, '2021-12-12 23:10:46');
...
--
ALTER TABLE `fuel_record`
  MODIFY `fuel_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `maintenance_vehicle`
  MODIFY `maintenance_vehicle_ID` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `quarterly_maintenance_vehicle`
  MODIFY `quarterly_maintenance_vehicle_ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `vehicle`
  MODIFY `Vehicle_ID` bigint(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `yearly_checklist_maintenance`
  MODIFY `yearly_checklist_maintenance_ID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
